        ...
        <div className="grid md:grid-cols-3 gap-[50px]">
          ...
          <div className='md:col-span-2'>
            <div className="flex items-center gap-5">
              ...
              leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>{specialization}
                </span>
            ...
            <div className='mt-[50]'>
              {
                tab==='about' && <DoctorAbout name={name} about={bio} qualifications={qualifications} experiences={experiences} />
              }
              {
